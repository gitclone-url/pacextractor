...
public class PacExtractor {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (!getString(pacHeader.szVersion).equals("BP_R1.0.0"))
            ...
            for (i = 0; i < partHeaders.length; i++) {
                ...
                in.seek(overflow_offset != 0 && overflow_offset < tmp ? tmp + 0x0100000000l : tmp);
                ...
                if (opf != null && opf.equals(getString(partHeaders[i].fileName)) && len < 1 * 1024 * 1024 * 1024l) {
                    len += 0x0100000000l;

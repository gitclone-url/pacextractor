...
# calculate/update CRC-16 Modbus DF1 using table above
...
# calculate CRC-16 Modbus DF1 without using table
# it is slower than using table
# taken from https://stackoverflow.com/questions/39101926/port-modbus-rtu-crc-to-python-from-c-sharp
# See https://github.com/LacobusVentura/MODBUS-CRC16 for time comparison
